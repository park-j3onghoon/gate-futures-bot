...
class AuthenticationException(message: String, cause: Throwable? = null) : GateFuturesException(message, cause)

class InsufficientBalanceException(message: String, cause: Throwable? = null) : GateFuturesException(message, cause)
